package id.ac.poliban.mi.aulia.homework_10b;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.aulia.homework_10b";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Data Storage Types_035 aulia-e020320035");
